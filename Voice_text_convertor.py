#Convert Speech to text and text to Speech: SomethingNew
#import packages
...
window.title("Convert Speech to text and text to Speech: SomethingNew")
title_label = Label(window, text="Convert Speech to text and text to Speech: SomethingNew").pack()
#Read inputs
